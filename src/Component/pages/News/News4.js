        ...
        <section className='col-md-4 border-top border-2 p-3' style={{ cursor: "pointer" }}>
            <article className='row border-end border-2'>
                <div className='col-md-6'>
                    <div className=' '>
                       <a href="#"> <img width="125px" src={props?.third?.photo} alt="" /></a>
                ...
                <dir className='col-md-6'>
                    <a href="#"><p>{props?.third?.suptitle && <span><span className='text-danger'>{props?.third?.suptitle}</span>/</span>}{props?.third?.title} </p></a>
                </dir>
            </article>
        </section>
